...
} shard_v2_index_entry_t;

/* ============================================================
 * Reader API
 * ============================================================ */

typedef struct shard_v2_reader shard_v2_reader_t;
 ...
 * shard_v2_read_entry() returns pointers directly into the mapping.
 * Call shard_v2_close() to munmap and close the file descriptor. */
...
/* Free the result of shard_v2_list_children(). */
...
typedef struct shard_v2_writer shard_v2_writer_t;
 ...
 *   shard_v2_stream_writer_set_alignment(sw, ALIGN_64);  // optional, before begin_data
 *   shard_v2_stream_writer_begin_data(sw);
 *   shard_v2_stream_writer_write_entry(sw, "weights", data, len);
 *   shard_v2_stream_writer_finalize(sw);
 *   shard_v2_stream_writer_free(sw);
 * ============================================================ */

typedef struct shard_v2_stream_writer shard_v2_stream_writer_t;
